	...
	<body>
		...
		<div class="searchbar">
		    <form action="/" method="get">
                <div style="display: table; width: 100%; color: <?php echo letsgetop("primary_color", "#8d7a42"); ?>;">
                    <div style="display: table-cell; width: 20px; padding: 10px;"><i class="fa fa-search"></i></div>
                    <div style="display: table-cell; padding: 10px;"><input type="text" name="s" id="search" placeholder="Search..." value="<?php the_search_query(); ?>" style="width: 100%; box-sizing: border-box;" /></div>
                    <div style="display: table-cell; width: 20px; padding: 10px;"><input type="submit" value="Cari" style="background-color: <?php echo letsgetop("primary_color", "#8d7a42"); ?>; color: white;"></div>
                </div>
            </form>
		</div>
